# go-wordpress
[![GoDoc](https://godoc.org/github.com/rxrw/go-wordpress?status.svg)](https://godoc.org/github.com/rxrw/go-wordpress)
...
```bash
go get github.com/rxrw/go-wordpress
```
...
cd $GOPATH/src/github.com/rxrw/go-wordpress
go test
```
